    ...
    public partial class form_Registration : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savedInfo.WriteLine(txtbx_FName.Text +", "+ txtbx_LName.Text + ", " + txtbx_Address.Text + ", " + cmb_Month.SelectedItem + ", " + cmb_Day.SelectedItem + ", " + cmb_Year.SelectedItem + ", " + txtbx_Gender.Text + ", " + txtbx_Contact1.Text + ", " + txtbx_Contact2.Text + ", " + txtbx_Time.Text + cmb_AMPM.SelectedItem + ", ");
                savedInfo.Close();
